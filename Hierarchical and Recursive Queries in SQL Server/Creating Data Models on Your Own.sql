...
-- learn how to
-- create and modify database tables. You will learn about relational and hierarchical data models, how they differ, and when each model should be used.
-- Creating a
-- table
-- In this exercise, you will
-- create a new table Person. For this task, you have to

-- define the table by using
-- CREATE TABLE
-- define the necessary fields of the desired table
-- An example for creating a table Employee is shown
-- below:
...
-- with the fields IndividualID,Firstname,Lastname, Address, and City.
...
-- A very important task when working
-- with tables is inserting and updating the values in a database. The syntax for both operations is shown below.

-- Insert value1
-- and value2 into the Employee
-- table:

-- INSERT INTO Employee
-- VALUES
--     (value1, value2);
-- Update field1 from table Employee with value1 for the ID
-- =1:
...
-- WHERE ID = 1;
-- Your task is to
-- insert two new values into
-- the
-- Person
-- table and to
-- update the entries of the table.
...
-- with
-- DROP TABLE, it
-- is possible to erase the entire table and its definition.
...
-- DROP TABLE Employee
-- Your task is to
-- delete some lines of the
-- previously defined Person table and finally, to
-- drop the entire table.

INSERT INTO Person
VALUES
    ('1', 'Andrew', 'Anderson', 'Adress 1', 'City 1', '1986-12-30');
INSERT INTO Person
VALUES
    ('2', 'Peter', 'Jackson', 'Adress 2', 'City 2', '1986-12-30');
INSERT INTO Person
VALUES
...
-- A very important concept of relational databases is the
-- use of primary and foreign keys. In this exercise, you will define a two new tables. A table Person,
-- with a PRIMARY KEY and another table, History,
-- with a PRIMARY KEY and a FOREIGN KEY referencing the Person table.
...
-- Inserting data
-- to person and order history
-- Next, you will
-- insert data
-- into the two newly generated tables, Person and History. Enter the following
-- orders:

-- Andrew Anderson bought an iPhone XS for 1000
-- Sam Smith bought a MacBook Pro for 1800
-- When inserting the customers and their orders into the tables make sure
-- that:
...
INSERT INTO Person
VALUES
    ('2', 'Sam', 'Smith', 'Flushing Ave 342', 'New York', '1986-12-30');
...
INSERT INTO Trip
VALUES
    ( 'San Francisco' , 'Bus 1' , 'New York');
-- Insert a route from Florida to San Francisco
INSERT INTO Trip
VALUES
    ( 'Florida' , 'Bus 9', 'San Francisco');
INSERT INTO Trip
VALUES
    ( 'San Francisco', 'Bus 2', 'Texas');
INSERT INTO Trip
VALUES
    ( 'San Francisco', 'Bus 3', 'Florida');
INSERT INTO Trip
VALUES
    ( 'San Francisco', 'Bus 4', 'Washington');
INSERT INTO Trip
VALUES
    ( 'New York', 'Bus 5', 'Texas');
INSERT INTO Trip
VALUES
    ( 'New York', 'Bus 6', 'Washington');
INSERT INTO Trip
VALUES
    ( 'Florida', 'Bus 7', 'New York');
INSERT INTO Trip
VALUES
    ( 'Florida', 'Bus 8', 'Toronto');
